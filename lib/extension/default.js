...
function Default (options) {
	...
	self.encoding = (self.extFull === 'jpg' || self.extFull === 'JPG' ||
				self.extFull === 'png' || self.extFull === 'PNG') ? 'binary' : 'utf8';
				//TODO: need to add more codtions
...
function setText (self) {
	return Fsep.readFile(self.abs, self.encoding).then(function (data) {
